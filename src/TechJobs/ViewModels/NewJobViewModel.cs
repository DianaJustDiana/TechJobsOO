...
namespace TechJobs.ViewModels
{
    public class NewJobViewModel
    {
        ...
        [Required(ErrorMessage = "You must include a location.")]
        [Display(Name = "Location")]
        public int LocationID { get; set; }
        
        [Required(ErrorMessage = "You must include a core competency.")]
        [Display(Name = "Core Competency")]
        public int CoreCompetencyID { get; set; }
        
        [Required(ErrorMessage = "You must include a position type.")]
